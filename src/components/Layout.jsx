...
export default function CustomLayout({ children }) {
  ...
  const onLogout = async () => {
    ...
    if (res.ok === 1) redirectTo("/auth/login")
  }
        ...
        <Layout
          ...
          <Sider
            ...
            <Menu
              ...
              <Menu.Item
                onClick={() => redirectTo("/data-forecast")}
                key='1'
                icon={<BarChartOutlined />}>
                Forecast
              </Menu.Item>
              <Menu.Item
                onClick={() => redirectTo("/weather")}
                key='2'
                icon={<AntCloudOutlined />}>
                Weather
              </Menu.Item>
              <Menu.Item
                onClick={() => redirectTo("/teriffs")}
                key='3'
                icon={<BankOutlined />}>
                Teriffs
              </Menu.Item>
              <Menu.Item
                onClick={() => redirectTo("/cost")}
                key='4'
                icon={<DollarOutlined />}>
                Cost
              </Menu.Item>
              <Menu.Item
                onClick={() => redirectTo("/spikes")}
                key='5'
                icon={<RiseOutlined />}>
                Spikes
              </Menu.Item>
              <Menu.Item
                onClick={() => redirectTo("/peak-hours")}
                key='6'
                icon={<SlidersOutlined />}>
                Peak Hours
              </Menu.Item>
              <Menu.Item
                onClick={() => redirectTo("/renewable-energy")}
                key='7'
